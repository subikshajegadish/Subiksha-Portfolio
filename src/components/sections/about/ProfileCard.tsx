...
export function ProfileCard() {
  return (
    <div className="box-border flex w-full max-w-145 flex-col items-center justify-between gap-7 rounded-[24px] border-3 border-navy bg-paper/84 px-6 py-8 text-center md:px-12 md:py-11 xl:h-162.5 xl:gap-0">
      ...
      <p className="m-0 text-[17px] leading-[1.5] font-medium text-ink md:text-[19px]">
