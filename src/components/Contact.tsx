...
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { Phone, Linkedin, Github, MapPin, Send } from 'lucide-react';
...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      label: "LinkedIn",
      value: "Subiksha Jegadish",
      link: "https://www.linkedin.com/in/subiksha-jegadish-7683031b2/"
    },
    {
      icon: <Github className="w-6 h-6 text-tech-blue" />,
      label: "GitHub",
  ...
  return (
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Contact Info Cards */}
        <div className="flex flex-wrap lg:flex-nowrap gap-6 mb-12 justify-center">
          {contactInfo.map((info, index) => (
            <a
              key={index}
              href={info.link}
            ...
            >
              <Card className="bg-white border-border hover-glow transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    {info.icon}
                    <div>
          ...
          {/* Location Card */}
          <Card className="bg-white border-border hover-glow transition-all duration-300 min-w-[200px] lg:min-w-[250px]">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                <MapPin className="w-6 h-6 text-neon-purple" />
                <div>
